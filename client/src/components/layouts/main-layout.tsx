            ...
            <div className="flex items-center">
              <Link href="/">
                <a className="flex-shrink-0 flex items-center">
                  ...
                  <span className="ml-2 text-xl font-bold text-dark">TechLearn</span>
                </a>
              </Link>
            ...
            <div className="flex items-center">
              <div className="hidden md:flex md:items-center md:space-x-4">
                {user ? (
                  ...
                  <>
                    <Link href="/auth">
                      <a className="text-gray-500 hover:text-primary px-3 py-2 rounded-md text-sm font-medium">
                        Sign In
                      </a>
                    </Link>
                    <Link href="/auth?tab=register">
                      <a className="bg-primary text-white hover:bg-blue-600 px-4 py-2 rounded-md text-sm font-medium">
                        Sign Up
                      </a>
                    </Link>
                  </>
      ...
      <footer className="bg-dark text-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-xl font-bold text-white">TechLearn</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/courses?category=ethical-hacking"><a className="hover:text-white">Ethical Hacking</a></Link></li>
                <li><Link href="/courses?category=programming"><a className="hover:text-white">Programming</a></Link></li>
                <li><Link href="/courses?category=excel-with-ai"><a className="hover:text-white">Excel with AI</a></Link></li>
                <li><Link href="/courses?category=digital-marketing"><a className="hover:text-white">Digital Marketing</a></Link></li>
              </ul>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-700">
            <p className="text-center text-sm">© {new Date().getFullYear()} TechLearn. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
